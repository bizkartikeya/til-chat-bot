...
const NavigationBar = () => {
  return (
    <div className='flex justify-between items-center p-5 h-12 w-svw' style={{ backgroundImage: `url(${navBg})`, backgroundRepeat:"no-repeat", backgroundSize:"cover" }}>
      <div className="flex flex-start items-center">
        <img src={tatalogo} className='h-10 w-10 m-2' alt="" />
        <div className="h-8 m-1 w-1 bg-white"></div>
      ...
      <div className="flex flex-end items-center">
        ...
        <img src={bmLogo} className='h-10 w-10 m-2' alt="" />
        <div className="h-8 w-1 bg-white m-1"></div>
